  ...
  return (
    <section id="contact" className="py-24 bg-white font-sans">
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto bg-primary rounded-4xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
          {/* Contact Info Sidebar */}
          <div className="md:w-2/5 bg-accent/90 p-12 text-primary flex flex-col justify-between">
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-6">
                   ...
                   <div>
                     <h4 className="font-bold opacity-50 text-xs uppercase tracking-widest">Store Location</h4>
                     <p className="font-medium">67 Heritage Road, Colombo, Sri Lanka</p>
                   </div>
                </div>
                <div className="flex items-center gap-6">
                   <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center">
                   ...
                   <div>
                     <h4 className="font-bold opacity-50 text-xs uppercase tracking-widest">Email Us</h4>
                     <p className="font-medium hover:text-primary transition-colors cursor-pointer">contact@radhalanka.com</p>
                   </div>
                </div>
                <a 
                ...
                >
                   <div className="w-10 h-10 rounded-full bg-primary/10 flex items-center justify-center group-hover:bg-[#25D366] group-hover:text-white transition-all duration-300">
                   ...
                   <div>
                     <h4 className="font-bold opacity-50 text-xs uppercase tracking-widest group-hover:text-[#25D366] transition-colors">WhatsApp Us</h4>
                     <p className="font-medium">+94 77 712 3456</p>
                   </div>
                </a>
              </div>
            </div>
          ...
          <div className="md:w-3/5 relative min-h-[400px] group/map">
            <iframe 
